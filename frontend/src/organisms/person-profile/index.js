  ...
  <div className="w-100 h-auto flexbox h-pr-fl-ma d-i-f">
      ...
      <div className="w-60 h-auto flex-auto d-i-f  h-pr-fl-ma c-p-2 c-br-2">
        <div className="w-80 h-auto  h-pr-fl-ma">
          <div className="w-100 h-auto c-f-1 d-i-f c-p-1 medium f-w-bo">NOMBRE APELLIDO</div>
          <div className="w-100 h-auto c-f-1 c-p-1 normal">FRASE PERSONAL</div>
        </div>
        <div className="w-20  h-auto flex-auto h-pr-fl-ma">
          <div className="w-auto r-h-c h-auto h-auto h-pr-fl-ma">
            <div className="w-100 h-auto c-f-1 nano h-auto">EDAD:</div>
            <div className="w-100 h-auto c-f-1 f-w-bo h-auto normal h-pr-fl-ma">00 AÑOS</div>
          </div>
        </div>
      </div>
